INSERT INTO `producer` (`name`, `regon`, `nip`, `telephone`) VALUES
('Kross', '2483587357', '29489252', '+48 726 761 841'),
('Kross', '2483587357', '29489252', '+48 726 761 841'),
('De One', '2483587357', '29489252', '+48 726 761 841'),
('Continental', '2483587357', '29489252', '+48 726 761 841'),
('Bosh', '2483587357', '29489252', '+48 726 761 841'),
('The Best', '2483587357', '29489252', '+48 726 761 841'),
('Americano', '2483587357', '29489252', '+48 726 761 841'),
('Corratec', '934123434', '87494999', '+48 943 123 551'),
('Unibike', '219423351', '261371542', '+48 175 135 129'),
('Grand', '246161461', '951363124', '+48 295 129 123'),
('Shimano', '268234123', '171236123', '+48 168 126 883'),
('Neco', '342442092', '184112331', '+48 822 851 812'),
('CTS', '112334554', '812128231', '+48 881 841 932');

INSERT INTO `category` (`name`, `description2`) VALUES
('Rowery miejskie', 'Rowery miejskie stanowią doskonałą propozycję dla miłośników codziennych wypraw po ośrodkach miejskich, ale śmiało można je zaproponować również entuzjastom popołudniowych przejażdżek. Oferowane przez nasz sklep modele rowerów miejskich odznaczają się niezawodnością i bezpieczeństwem, a dzięki starannie zaprojektowanym konstrukcjom zapewniają maksimum komfortu i wygody. Większość dostępnych rowerów posiada bogate wyposażenie, takie jak błotniki, oświetlenie czy bagażnik.'),
('Rowery górskie', 'Rowery górskie na dużych, 29-calowych kołach znakomicie pokonują przeszkody na trudnych ścieżkach. Większa powierzchnia styku opony z podłożem sprawia, że 29ery nie zapadają się w grząskim czy piaszczystym terenie i umożliwiają swobodny przejazd tam, gdzie rower na kołach 26-calowych może mieć problemy. Większe koła sprawiają, że baza kół, czyli długość roweru, jest większa, co nieco zmniejsza zwrotność. Poza najbardziej krętymi singletrackami jest jednak w zupełności wystarczająca na większości szlaków. Rewelacyjna przyczepność i łatwość przejazdu nawet przez duże kamienie czy korzenie sprawia, że 29er to świetny towarzysz większości terenowych podróży. Warto pamiętać, że dobierając rozmiar ramy, zwykle należy się zastanowić nad mniejszym rozmiarem, niż w przypadku odpowiadającego nam, klasycznego roweru na kołach 26'),
