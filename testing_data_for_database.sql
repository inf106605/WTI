...
ALTER TABLE `addresses` AUTO_INCREMENT=42;
...
ALTER TABLE `contact` AUTO_INCREMENT=39;
...
ALTER TABLE `client` AUTO_INCREMENT=18;
...
ALTER TABLE `producer` AUTO_INCREMENT=27;
...
(12, 'SPD M520'),
(13, 'Tornado');
ALTER TABLE `tag` AUTO_INCREMENT=14;
